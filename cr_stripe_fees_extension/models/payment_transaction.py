...
class PaymentTransaction(models.Model):
    ...
    def _stripe_prepare_payment_intent_payload(self):
        ...
        if stripe_provider.is_extra_fees:
            ...
            total_fixed_fees = stripe_provider.fix_domestic_fees + stripe_provider.fix_international_fees
            total_percent_fees = ((stripe_provider.var_domestic_fees * base_amount) / 100) + ((stripe_provider.var_international_fees * base_amount) / 100)
