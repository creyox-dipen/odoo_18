...
class ReportDesignerComponent(models.Model):
    ...
    template_id = fields.Many2one(
        "report.designer.template", string="Template", required=True, ondelete="cascade"
    )
    page_id = fields.Many2one(
        "report.designer.template.page",
        string="Page",
        required=True,
        ondelete="cascade",
    )
    ...
    parent_id = fields.Many2one(
        "report.designer.component", string="Parent Component", ondelete="cascade"
    )
    children_ids = fields.One2many(
        "report.designer.component", "parent_id", string="Child Components"
    )
