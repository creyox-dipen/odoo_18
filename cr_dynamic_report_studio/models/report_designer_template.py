    ...
    def compile_qweb_arch(self):
        ...
        for p_idx, page in enumerate(pages):
            ...
            for seg in segments:
                ...
                has_table = any(e.get('type') == 'table' for e in seg['els'])
                if has_table:
                    page_css = (
                        f"position: relative; "
                        f"width: {self.paper_width}mm; "
                        f"min-height: {self.paper_height - 0.5}mm; "
                ...
                if seg_body_els:
                    ...
                    if has_table:
                        xml.append(f'        <div style="position: absolute; left: {content_left}pt; top: {content_top}pt; width: {content_width}pt; min-height: {content_height}pt; margin: 0; padding: 0;">')
                    else:
                        ...
                        if block['type'] == 'abs':
                            if flow_y_offset > 0:
                                ...
                                if container_height < 0:
                                    container_height = 0
                                xml.append(f'        <div style="position: relative; height: {container_height}pt; page-break-inside: avoid;">')
