...
{
    "name": "Stripe ACH Invoice Integration | Stripe ACH Direct Debit Integration | Stripe ACH Direct Debit For Invoicing | ACH Bank Transfer Invoice Integration",
    "author": "Creyox Technologies",
    "website": "https://www.creyox.com",
    "support": "support@creyox.com",
    "category": "Accounting",
    "summary": """
    The Stripe ACH Invoice Integration module enables businesses to accept invoice payments in Odoo through ACH Direct Debit (bank transfer) with Stripe. Customers can pay invoices securely using their bank details, and the payment process is fully automated from initiation to confirmation.

    When Stripe confirms the ACH transfer, the module updates Odoo automatically, marking the invoice as paid without manual reconciliation. This provides a faster, error-free, and professional payment flow, giving businesses a convenient and reliable way to manage invoice payments.
