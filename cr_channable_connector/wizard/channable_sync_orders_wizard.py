...
class ChannableSyncOrdersWizard(models.TransientModel):
    ...
    def _get_or_create_partner(self, billing_data, marketplace, country_cache=None, state_cache=None, partner_cache=None, customer_data=None):
        """
        ...
        partner_vals = {
            'name': full_name,
            'email': email,
            'phone': str(billing_data.get('phone') or customer_data.get('phone') or '').strip(),
            'mobile': str(billing_data.get('mobile') or billing_data.get('mobile_phone') or customer_data.get('mobile') or customer_data.get('mobile_phone') or '').strip(),
    ...
    def _get_or_create_shipping_partner(self, shipping_data, invoice_partner, marketplace, country_cache=None, state_cache=None, shipping_partner_cache=None, customer_data=None):
        """
        ...
        ship_vals = {
            ...
            'city': ship_city,
            'zip': ship_zip,
            'phone': str(shipping_data.get('phone') or customer_data.get('phone') or '').strip() or invoice_partner.phone,
            'mobile': str(shipping_data.get('mobile') or shipping_data.get('mobile_phone') or customer_data.get('mobile') or customer_data.get('mobile_phone') or '').strip() or invoice_partner.mobile,
    ...
    def _process_order_batch(self, orders_data, marketplace, country_cache=None, state_cache=None, partner_cache=None, shipping_partner_cache=None):
        ...
        for order_data in orders_data:
            ...
            customer_data = inner_data.get('customer', {})
