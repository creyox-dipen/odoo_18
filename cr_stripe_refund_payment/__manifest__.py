...
{
    "name": "Stripe Refund Invoice Payment | Odoo Stripe Partial And Full Refunds | Refund Stripe Payments From Odoo Backend | Odoo Stripe refund and credit note integration",
    ...
    Users can either request a full refund or a partial refund according to their needs. A credit note is automatically generated for the refunded amount, ensuring accurate financial records. This reduces manual effort, prevents errors, and helps businesses handle refund requests smoothly and efficiently within Odoo.
